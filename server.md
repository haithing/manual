...
| **Ctrl+P**（或向上箭头） |   获取前一个历史命令   | **Ctrl+N**（或向下箭头） | 获取后一个历史命令 |
| **Ctrl+B**（或左箭头键） |   将光标回退一个字符   | **Ctrl+F**（或右箭头键） | 将光标前进一个字符 |
|        **Ctrl+A**        |     移动光标至行首     |        **Ctrl+E**        |   移动光标至行尾   |
|        **Ctrl+K**        |   删除光标之后的内容   |        **Ctrl+U**        | 删除光标之前的内容 |
|        **Ctrl+W**        | 删除光标之前的一个单词 |        **Ctrl+Y**        | 恢复之前删除的内容 |
|        **Ctrl+T**        |   交换前两个字符位置   |
